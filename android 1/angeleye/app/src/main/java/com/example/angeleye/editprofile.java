...
//                                JSONObject js= jsonObj.getJSONObject("name");
                                ...
                                e2.setText(jsonObj.getString("dob"));
                                e3.setText(jsonObj.getString("place"));
                                e4.setText(jsonObj.getString("pin"));
                                e5.setText(jsonObj.getString("post"));
                                e6.setText(jsonObj.getString("city"));
                                e7.setText(jsonObj.getString("email"));
                                e8.setText(jsonObj.getString("phone"));
                                r1.setText(jsonObj.getString("male"));
                                r2.setText(jsonObj.getString("female"));
    ...
    public void onClick(View view) {
        ...
        (view == im1) {
            ...
            else if (!city.matches("^[a-z,A-Z]*$"))
            {
                ...
                String uid = sh.getString("uid", "");
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":8000/myapp/updateprofile/";
