...
//			mChannel.setVibrationPattern(new long[]{0, 800, 200, 1200, 300, 2000, 400, 4000});
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), "my_channel_01")
                ...
                .setContentTitle("Angel Eyes")
                .setContentText("You Have an Emergency from:"+names);
...
//		builder.setContentIntent(resultPendingIntent);
    ...
    void getNotification() {
        ...
        String url = "http://" + sp.getString("ip", "")+ ":8000/myapp/caretaker_view_em/";
...
//                        JSONObject jsa=jsonObj.getJSONObject("data");
                        notification_popup(jsonObj.getString("name"));
                        SharedPreferences  sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                        SharedPreferences.Editor edp=sh.edit();
                        edp.putString("rid",jsonObj.getString("eid"));
                        edp.putString("bid",jsonObj.getString("bid"));
                        edp.putString("ulid",jsonObj.getString("cid"));
                        edp.putString("name",jsonObj.getString("name"));
                        edp.putString("lat",jsonObj.getString("lat"));
                        edp.putString("longi",jsonObj.getString("longi"));
                        edp.putString("locationname",jsonObj.getString("locationname"));

                        edp.commit();



                        Intent ii=new Intent(getApplicationContext(),emergency_popup.class);
...
//                       }
        ...
        })
        {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("rid",sp.getString("rid","0") );
