...
public class viewfamiliar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + hu + ":8000/myapp/viewfamiliar/";
...
//                                ArrayAdapter<String> adpt=new ArrayAdapter<String>(getApplicationContext(),android.R.layout.simple_list_item_1,name);
                                l1.setAdapter(new customviewfamiliar(getApplicationContext(), id, image, name,relation));
