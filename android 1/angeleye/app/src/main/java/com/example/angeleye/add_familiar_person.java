...
public class add_familiar_person extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relation = findViewById(R.id.editTextTextPersonName18);
    ...
    public void onClick(View view) {
        ...
        String Frelation = relation.getText().toString();
        ...
        if (Fname.length() == 0) {
            ...
            relation.setError("Missing");
            relation.requestFocus();
        } else if (!Frelation.matches("^[a-z,A-Z]*$")) {
            relation.setError("Characters Allowed");
            relation.requestFocus();
        } else {
            ...
            String url = "http://" + hu + ":8000/myapp/addfamiliar/";
